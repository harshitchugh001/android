...
class MainOuterToolber : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main_outer_toolber)
        val toolberr = findViewById<Toolbar>(R.id.toolberr)
        toolberr.title ="Home"
        toolberr.subtitle ="Main Page"
        setSupportActionBar(toolberr)
    }
